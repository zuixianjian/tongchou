...
public class XbootGenerator {
     ...
     * 建议仅需修改
     */
    private static final String className = "CarTypeRelation";

    /**
     * 类说明描述
     * 建议仅需修改
     */
    private static final String description = "车型关联信息表";

    /**
     * 作者名
     * 建议仅需修改
     */
    private static final String author = "Jingqi Chen";
     ...
     * 下方请根据需要修改
     */
    private static final String tablePre = "b_";
